const listOfProjects = [
    ...
    },
    {
        ...
        objectivesDetails:
            "In my role at Noa Ignite, I supported key development aspects for Bama Gruppen's transportation optimization application. I contributed to refining data handling with GraphQL and Apollo Client, and enhanced the user interface with Tanstack Table for data dispaly and interaction. I led the creation of a robust UI component library utilizing Storybook, which streamlined the development workflow within the TurboRepo monorepo structure. My work supported the overarching objective of delivering innovative and efficient logistics solutions, significantly contributing to the project's success and recognition with the 'Insight Award 2023'.",
        isInternal: true,
        isProfessional: true,
